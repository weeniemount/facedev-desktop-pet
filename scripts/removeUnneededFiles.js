...
exports.default = async function(context) {
    ...
    fs.readdir(mainDir, function(err, files) {
        ...
        files.forEach(file => {
            ...
            const filesToKeep = ['FaceDev Desktop Pet.exe', 'ffmpeg.dll', 'icudtl.dat', 'resources.pak', 'v8_context_snapshot.bin', 'resources', 'locales', 'chrome_100_percent.pak', 'chrome_200_percent.pak', 'swiftshader'];
